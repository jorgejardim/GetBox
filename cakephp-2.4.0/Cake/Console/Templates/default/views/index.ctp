...
<div class="<?php echo $pluralVar; ?> index">
	...
	<?php foreach ($fields as $field): ?>
		<th><?php echo "<?php echo \$this->Paginator->sort('{$field}', '" . Inflector::humanize($field) . "'); ?>"; ?></th>
	<?php endforeach; ?>
...
<div class="actions">
	...
	<ul>
		<li><?php echo "<?php echo \$this->Html->link(__('New').' '.__('" . $singularHumanName . "'), array('action' => 'add')); ?>"; ?></li>
<?php
	$done = array();
